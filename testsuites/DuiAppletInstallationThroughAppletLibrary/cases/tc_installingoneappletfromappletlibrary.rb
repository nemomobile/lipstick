...
class TC_DuiAppletInstallationThroughAppletLibrary < Dui::TestCase
    ...
    def test_1_show_installation_source
        ...
        verify { accessInstallationSource }

        # Check the prestate
        # - Applet library is shown with one installation source
        verify { @app.DuiContainer(:name => 'DuiAppletInventorySourceContainer').InstallationSourceWidget }
        ...
        verify { @app.DuiButton(:text => 'Installable') }
        verify { @app.DuiButton(:text => 'Uninstallable') }
        verify { @app.DuiButton(:text => 'Not Downloadable') }
        verify { @app.DuiButton(:text => 'Metadata Only') }
        verify { @app.DuiButton(:text => 'Non-existent') }
...
#         end
        ...
        verify_not { @app.DuiProgressIndicator }
...
#         end
        ...
        verify_not { @app.DuiProgressIndicator }
        verify { @app.DuiAppletHandle(:state => 'BROKEN') }
        ...
        verify { @app.DuiMessageBox.DuiButton }
        ...
        verify_not { @app.DuiAppletHandle }
...
#         verify_not(2) { @app.DuiAppletHandle }
    ...
    def test_7_applet_installation_has_succeeded
        ...
        verify_not { @app.DuiProgressIndicator }
        verify { @app.DuiAppletHandle(:state => 'RUNNING') }
    end
    ...
    def test_8_applet_installation_still_in_progress
        ...
        verify { @app.DuiProgressIndicator }
    end
...
private
    ...
    def removeAllApplets
        begin
            @app.DuiModalSceneWindow(:name=>"AppletSpaceWindow", :__timeout=>0)
        rescue
            @app.DuiButton(:text => "Applet Space").tap
        end
        ...
        begin
            while @app.DuiMashupCanvas.DuiContainer(:__index => 0, :__timeout => 5)
                ...
                @app.DuiObjectMenu.DuiButton(:__index => 0).tap
            end
        rescue
        end

        @app.DuiButton(:text => "Applet Space").tap
        verify_not { @app.DuiModalSceneWindow(:name=>"AppletSpaceWindow") }                                                                                
    end                                                                                                                                                                          
    ...
    def startInstallationProcess(buttonText)
        ...
        verify_not { @app.DuiAppletInventory }
    end
    ...
    def monitorInstallationStatus
        ...
        begin                                                                                                                                              
            ...
            while true                                                                                                                                     
                ...
                verify(0) { progressIndicator.attribute('value').to_i == testDBusService.lastOperationProgress }
            end
        rescue
        end
    end                                                                                                                                                    
