...
equals(QT_MAJOR_VERSION, 5): PKGCONFIG += xcomposite mlite5 xdamage x11 xfixes xext mce dbus-1 dbus-glib-1 libresourceqt1 ngf-qt5
...
equals(QT_MAJOR_VERSION, 4): QT += network svg dbus xml declarative sql
equals(QT_MAJOR_VERSION, 5): QT += network svg dbus xml declarative sql systeminfo
