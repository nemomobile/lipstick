...
test_xml.commands=buildTestXml.rb -tmeta/tests.xml.in -i $$TEST_BENCHMARKS_INSTALL_LOCATION -f \"$$TEST_SUITES\" && ./patch-tests-xml < meta/tests.xml.in > meta/tests.xml && $$XMLLINT --noout --schema ../testsuites/testdefinition.xsd meta/tests.xml
